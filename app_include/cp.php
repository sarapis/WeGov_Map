...
class SubView
{
	...
	<!-- details -->
		<div id='details'>
			...
			<div class="row">
				<p class="col-3 ml-0 flex pr-0"><small>Project ID:</small></p>
				<h4 class="col-3 badge badge-pill badge-info" style="text-align: center; margin: 2px 0 -2px;">
					<span id="details-capID" class="details"></span>
				</h4>
				<p class="col-4 mr-0"><small># reports:</small><a id="details-reportsNum" class="details"></a></p>
			</div>
